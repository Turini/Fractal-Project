...
<body> <c:import url="cabecalho.jsp"/>
	...
	<div id="master" style="background-color: #E8E8E8; height: 980px"> <br>
		...
		<div id="project-div" style="background-color: gray; float: right; height: 100%; width:80%;">
			...
			<div class="sortables-console" style="margin-top: 3%; margin-left: 1%; height: 85%; width:97%; background-color: #B5B5B5; float: right;"> <br/>
